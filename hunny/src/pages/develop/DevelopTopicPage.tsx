    ...
    content: (
      <>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          プロジェクトに対して何かを行動を起したいときはまず <code className="bg-amber-100 dark:bg-gray-800 text-amber-900 dark:text-amber-300 px-1.5 py-0.5 rounded text-sm">issue</code> を発行しましょう。
        </p>
        ...
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-3">
          <li><code className="bg-amber-100 dark:bg-gray-800 text-amber-900 dark:text-amber-300 px-1.5 py-0.5 rounded text-sm">[Bug] button is not working</code> ボタンが反応しません</li>
          <li><code className="bg-amber-100 dark:bg-gray-800 text-amber-900 dark:text-amber-300 px-1.5 py-0.5 rounded text-sm">[FR] customize theme color</code> 色をカスタマイズする新機能</li>
        </ul>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2">のようなタイトルを決めます。</p>
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-6">
          <li>バグの報告: <code className="bg-amber-100 dark:bg-gray-800 text-amber-900 dark:text-amber-300 px-1.5 py-0.5 rounded text-sm">[Bug]</code></li>
          <li>新しい機能のリクエスト: <code className="bg-amber-100 dark:bg-gray-800 text-amber-900 dark:text-amber-300 px-1.5 py-0.5 rounded text-sm">[FR]</code></li>
        </ul>
  ...
  return (
    <>
      ...
      <nav className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-6">
        <a href="/develop/index" className="hover:text-amber-700 dark:hover:text-amber-300 transition-colors">共同開発</a>
        <span>/</span>
