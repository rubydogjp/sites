    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          <li>PC の中に作られた <code className="bg-amber-100 dark:bg-gray-800 text-amber-900 dark:text-amber-300 px-1 py-0.5 rounded text-xs">hunny</code> フォルダごと消すことができます。</li>
        ...
        <CodeBlock>{"https://github.com/<ユーザーID>/hunny/settings"}</CodeBlock>
        <p className="mb-2">
