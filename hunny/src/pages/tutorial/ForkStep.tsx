...
const slides: SubSlide[] = [
  ...
  // 2.1 fork
  {
    ...
    narration: (
      <>
        <p>GitHub の画面からハニープロジェクトをフォークします。</p>
    ...
    action: (
      <ActionSim
        type="browser"
        command="https://github.com/rubydogjp/hunny/fork"
  ...
  // 2.2 clone
  {
    ...
    action: (
      <ActionSim
        type="terminal"
        command="$ git clone https://<アクセストークン>@github.com/<ユーザーID>/hunny.git"
        output={`Cloning into 'hunny'...\nremote: Enumerating objects: 128, done.\nResolving deltas: 100% (42/42), done.`}
        note={<>例: <InlineCode>git clone https://ghp_Xxxx...@github.com/rbdog/hunny.git</InlineCode></>}
      />
    ),
  },
  // 2.3 upstream
