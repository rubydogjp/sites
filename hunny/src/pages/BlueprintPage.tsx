      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-10">
        ...
        <div className="rounded-2xl overflow-hidden border" style={{ borderColor: GRID }}>
          <svg width="100%" viewBox={`0 0 ${S} ${S}`} style={{ backgroundColor: BG }}>
            ...
            <text x={S - 155} y={S - 32} fill={WHITE} fontSize="10" fontFamily="monospace" fontWeight="bold">HUNNY ICON</text>
          ...
          {[
            {
              ...
              specs: [
                ...
                ["Radius", "14 (of 32)"],
                ["Fill", "hunny-100  #fef9c3"],
                ["Stroke", "hunny-500  #eab308"],
                ["Stroke Width", "2"],
                ["Stroke Join", "round"],
              ],
              fillSwatch: "#fef9c3",
        ...
        <div>
          ...
          <div className="rounded-xl border overflow-hidden" style={{ borderColor: GRID }}>
            <div className="px-4 py-2 flex items-center justify-between" style={{ backgroundColor: "#0f1d32" }}>
              <span className="font-mono text-xs" style={{ color: FAINT }}>HunnyIcon.bas</span>
              <button
