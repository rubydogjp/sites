    ...
    <div className="flex justify-between mt-12 pt-6 border-t border-amber-200/40 dark:border-gray-800 gap-4">
      ...
      {next ? (
        <Link
          ...
          className="group flex items-center gap-3 px-4 py-3 border border-amber-200/60 dark:border-gray-800 rounded-xl hover:border-amber-400 dark:hover:border-amber-600 transition-colors max-w-[45%] ml-auto"
        >
